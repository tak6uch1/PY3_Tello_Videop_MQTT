...
class TelloUI:
    ...
    def on_message(self, client, userdata, msg):
        ...
        if command == "Land":
            return self.tello.send_command('land')
        elif command == "Take off":
            return self.tello.send_command('takeoff')
        elif command == "Rotate counterclockwise":
            return self.tello.send_command('ccw 30')
        elif command == "Rotate clockwise":
            return self.tello.send_command('cw 30')
        elif command == "Left":
            return self.tello.send_command('left 30')
        elif command == "Right":
            return self.tello.send_command('right 30')
        elif command == "Back":
            return self.tello.send_command('back 30')
        elif command == "Forward":
            return self.tello.send_command('forward 30')
        elif command == "Up":
            return self.tello.send_command('up 30')
        elif command == "Down":
            return self.tello.send_command('down 30')
        elif command == "Flip left":
            return self.tello.send_command('flip l')
        elif command == "Flip right":
            return self.tello.send_command('flip r')
        elif command == "Flip forward":
            return self.tello.send_command('flip f')
        elif command == "Flip back":
            return self.tello.send_command('flip b')
        time.sleep(0.3)
    ...
    def init_mqtt(self):
        ...
        self.client.tls_set("mosquitto.org.crt")
        self.client.connect("test.mosquitto.org", 8883)

    def start_mqtt_sub(self):
